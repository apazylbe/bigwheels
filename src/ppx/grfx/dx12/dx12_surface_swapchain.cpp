...
#include "ppx/grfx/dx12/dx12_surface_swapchain.h"
...
Result SurfaceSwapchain::CreateColorImages(uint32_t width, uint32_t height, grfx::Format format, const std::vector<ID3D12Resource*>& colorImages)
{
...
Result SurfaceSwapchain::Resize(uint32_t width, uint32_t height)
{
