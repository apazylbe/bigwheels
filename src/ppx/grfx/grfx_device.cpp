...
void Device::Destroy()
{
    ...
    DestroyAllObjects(mVirtualSwapchains);
...
Result Device::AllocateObject(grfx::VirtualSwapchain** ppObject)
{
    grfx::VirtualSwapchain* pObject = new grfx::VirtualSwapchain();
    if (IsNull(pObject)) {
        return ppx::ERROR_ALLOCATION_FAILED;
    }
    *ppObject = pObject;
...
Result Device::CreateSwapchain(const grfx::SwapchainCreateInfo* pCreateInfo, grfx::Swapchain** ppSwapchain)
{
    ...
    switch (pCreateInfo->type) {
        ...
        case grfx::SwapchainType::SWAPCHAIN_TYPE_SURFACE:
            ...
            break;
        case grfx::SwapchainType::SWAPCHAIN_TYPE_VIRTUAL:
            result = CreateObject(pCreateInfo, mVirtualSwapchains, (grfx::VirtualSwapchain**)ppSwapchain);
            break;
    }
    return result;
}
...
void Device::DestroySwapchain(const grfx::Swapchain* pSwapchain)
{
    ...
    switch (pSwapchain->GetType()) {
        default:
            ...
            break;
        case grfx::SwapchainType::SWAPCHAIN_TYPE_VIRTUAL:
            DestroyObject(mVirtualSwapchains, dynamic_cast<const grfx::VirtualSwapchain*>(pSwapchain));
            break;
        case grfx::SwapchainType::SWAPCHAIN_TYPE_SURFACE:
